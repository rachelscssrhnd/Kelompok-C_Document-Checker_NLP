...
_MODEL_MINILM: Optional[SentenceTransformer] = None
_MODEL_MPNET: Optional[SentenceTransformer] = None
_MODEL_MULTI: Optional[SentenceTransformer] = None
...
def run_checker(filepaths: List[str]) -> Dict[str, Any]:
    """
    Main function to run document similarity analysis.
