        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-6xl mx-auto">
            ...
            <MetricCard
              ...
              title="Levenshtein"
              category="Tekstual"
              description="Mengukur jarak edit minimum untuk mengubah satu teks ke teks lain."
            />
            <MetricCard
              icon={<FileText className="w-6 h-6" />}
              title="Jaro-Winkler"
              category="Tekstual"
              description="Mengukur kemiripan karakter dengan penekanan pada awalan teks."
            />
            <MetricCard
...
const MetricCard = ({
  ...
  <div className="bg-card rounded-xl border border-border p-5 shadow-card hover:shadow-md transition-shadow">
    ...
    <h4 className="text-base font-semibold text-foreground mt-1 mb-2">{title}</h4>
